...
export const DERIVED_NOTICE =
  "A automation is drawn on the desk of the first agent it runs through — the company scopes automations to itself, not to a desk. Everything else on this graph is declared.";
