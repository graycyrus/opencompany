...
export const DERIVED_NOTICE =
  "A workflow is drawn on the desk of the first agent it runs through — the company scopes flows to itself, not to a desk. Everything else on this graph is declared.";
