...
describe("ApprovalCard decide ordering (#1406)", () => {
  ...
  it("names a automation grant revocation after the automation (#1411)", async () => {
  ...
  it("names a automation gate's broad approve after the automation, not a agent (#1411)", async () => {
