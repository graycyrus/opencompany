...
//
// The OTHER Add-teammate dialog — `views/room/AddMemberDialog`, reached from
...
import type { NewMemberFields } from "@/views/room/AddMemberDialog";
...
const { AddMemberDialog } = await import("@/views/room/AddMemberDialog");
