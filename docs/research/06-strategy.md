...
Ordered by unblocking power, not size. Sourced from
[`STATUS.md`](../spec/feature-audit/STATUS.md).
...
> [07-architecture-facts.md](07-architecture-facts.md#fact-1--there-are-two-tool-paths-and-they-do-not-meet).
