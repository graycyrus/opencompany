...
| `RequireApproval` | Converted to a model-facing error string at `middleware.rs:1423-1462`; never parks, never journals, never reaches an operator ([Fact 5](07-architecture-facts.md#fact-5--tool-approval-never-reaches-opencompany)) |
...
1. **The enforcement path must exist.** Tools attached, denials journaled, budgets
   ...
   [R1–R6](09-feature-briefs.md) — Tier 0 through Tier 2.
